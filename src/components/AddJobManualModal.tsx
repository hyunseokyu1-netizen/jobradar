      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full text-sm border border-zinc-200 rounded-lg px-3 py-2.5 outline-none focus:border-zinc-400 transition-colors placeholder:text-zinc-300"
              autoFocus
              disabled={busy}
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-zinc-500 mb-1">회사</label>
              <input
                value={company}
            ...
            <div>
              <label className="block text-xs font-medium text-zinc-500 mb-1">위치</label>
              <input
                value={location}
          ...
          <div>
            <label className="block text-xs font-medium text-zinc-500 mb-1">
              채용공고 내용 (JD) <span className="text-zinc-300">— 선택</span>
            </label>
            <textarea
              value={description}
        ...
        <div className="flex items-center justify-between p-6 border-t border-zinc-100">
          ...
          <div className="flex gap-2">
            <button onClick={onClose} className="text-sm text-zinc-400 hover:text-zinc-600 px-4 py-2" disabled={busy}>
              취소
            </button>
            <button
