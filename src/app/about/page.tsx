...
const STEPS = [
  ...
  },
  {
    n: '3',
    title: '공고 수집과 AI 매칭',
    desc: '관심 기업 채용페이지를 등록하고 수집 버튼 한 번이면 공고를 모아 내 이력서와의 적합도를 0~100점으로 채점합니다.',
  },
  {
    n: '4',
    title: '맞춤 이력서로 지원',
...
const FEATURES = [
  ...
  { title: '공고 한 번에 수집·채점', desc: 'OpenAI·Stripe·Xero 등 기업 채용페이지를 원클릭 등록·수집하면 AI가 공고를 채점해 정렬합니다.' },
    ...
    <div className="min-h-screen bg-white font-[family-name:var(--font-plex-kr)] text-[#111827] antialiased">
      ...
      <section className="mx-auto max-w-[840px] px-4 pb-14 pt-16 text-center sm:px-8 sm:pt-24">
        ...
        <p className="mx-auto mt-5 max-w-[560px] text-[16px] leading-[1.65] text-[#4B5563]">
          ...
          한국어 이력서를 전문가 수준의 영어로 번역하고, 관심 회사의 채용 공고를 한 번에 수집·채점하고,
